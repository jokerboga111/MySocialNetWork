    ...
    <div id="wrap-content">
        ...
        <div id="sidebar">
            ...
            <div class="panel-side">
                ...
                <form name="sendform" action="/Zayavka?idf=<%=us.getID()%>&login=<%=u.getlogin()%>&id=<%=u.getID()%>" method="post" >
                <input type="submit" value="Добавить в друзья" name="send">
                </form>
                <form name="sendform" action="/socc2s/lichnoeSoobshenye.jsp?login=<%=us.getlogin()%>" method="post" >
