        ...
        <div id="sidebar">
            ...
            <div class="panel-side">
                ...
                <ul class="check-user">
                    ...
                    <li><a href="/socc2s/dialogs.jsp">Мои сообщения</a></li>
...
<div id="content">
    ...
    <%List<DialogExm> listdial= (List<DialogExm>) request.getAttribute("Dialogi");
        for(DialogExm dia:listdial){

    %>
    <div class="usertop">
        <img src="/socc2s/images/camera_200.png" width="40" height="40">
        <div class="name"><a href="/poiscDialog?idSel=<%=u.getID()%>&login=<%=dia.getName()%>"><%=dia.getName()%></a></div>
        <div class="on">Online</div>
    </div>
    <%}%>
