...
<div id="wrapper">
    <div id="wrap-content">
        ...
        <div id="content">
            ...
            <div id="header1">
                <ul>
                    <li><a href="/socc2s/friends/OnlineFriends.jsp">Группы</a></li>
                    <li><a href="/PoiskDruzey?idfri=<%=u.getID()%>">Публичные страницы</a></li>
                    <li><a href="/PoiskZayavka?idZ=<%=u.getID()%>">Мероприятия</a></li>
                </ul>
            </div>
