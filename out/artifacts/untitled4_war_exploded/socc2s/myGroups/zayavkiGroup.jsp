        ...
        <div id="content">
            ...
            <div class="panel-side">
                <%  String idGroup=request.getParameter("idGroup");
                    List<User> list= (List<User>) request.getAttribute("UserZ_A");
                        for(User user1:list ){
                %>
                <div class="usertop">
                    ...
                    <form name="sendform" action="/DobavityVGroup?NameGroup=<%=request.getParameter("NameGroup")%>&id=<%=u.getID()%>&idGroup=<%=idGroup%>&idFriend=<%=user1.getID()%>" method="post" >
                        <input style="float:right" type="submit" value="Добавить в группу" name="send">
                    </form>
                </div>
                <%}%>
            </div>
