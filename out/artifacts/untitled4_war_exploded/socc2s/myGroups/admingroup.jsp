...
<div id="wrapper">
    <div id="wrap-content">
        ...
        <div id="content">
            ...
            <div class="panel-side">
                <%List<Groups> list= (List<Groups>) request.getAttribute("UserZaiAdm");
                    for(Groups g:list ){
                %>
                <div class="usertop">
                    <img src="/socc2s/images/camera_200.png" width="40" height="40">
                    <div class="name"><a href="/socc2s/myGroups/UpravlenyeGrop.jsp?idGroup=<%=g.getIdGroup()%>&NameGroup=<%=g.getNameGroup()%>&idUser=<%=u.getID()%>" name="log"><%=g.getNameGroup()%></a></div>
                </div>
                <%}%>
            </div>
