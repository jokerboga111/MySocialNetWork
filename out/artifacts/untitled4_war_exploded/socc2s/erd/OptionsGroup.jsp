  ...
  <div class="row1">
    <div class="panel-body" style="background-color:#fff;color:#000000;">
      ...
      <ul class="nav nav-tabs">
        ...
        <li><a href="#tab-2" data-toggle="tab">Участники</a></li>
        <li><a href="#tab-3" data-toggle="tab">Черный список</a></li>
        <li><a href="#tab-4" data-toggle="tab">Ссылки</a></li>
        <li><a href="#tab-5" data-toggle="tab">Ключи доступа</a></li>
      </ul>
      <div class="tab-content">
        <div class="tab-pane active" id="tab-1">
          <div class="well">
            <div class="panel-side">
              <form action="/OptionsGroup?id=<%=request.getParameter("idGroup")%>" method="post">
              Название:<input type="text" name="nameGroup" size="20"><br>
              Адрес страницы:<input type="text" name="codeGroup" size="20"><br>
              Описание сообщества:<textarea name="InfoGroup" id="post_field3" style="width: 550px;height:120px;"></textarea><br>
              Тематика сообщества:<input type="text" name="TemaGroup" size="20"><br>
              Веб-сайт:<input type="text" name="WebSite" size="20"><br>
              Возрастные ограничения:<input type="text" name="oldFilter" size="20"><br>
              Фильтр комментариев:<input type="text" name="commentFilter" size="20"><br>
              Местоположение:<input type="text" name="AdresGroup" size="20"><br>
              Сообщения сообщества:<input type="text" name="massageGroup" size="20"><br>
              Стена:<input type="text" name="wall" size="20"><br>
              Фотографии:<input type="text" name="photo" size="20"><br>
              Видеозаписи:<input type="text" name="video" size="20"><br>
              Аудиозаписи:<input type="text" name="audio" size="20"><br>
              Документы:<input type="text" name="document" size="20"><br>
              Обсуждения:<input type="text" name="beseda" size="20"><br>
              Материалы:<input type="text" name="matirial" size="20"><br>
              Тип группы:<input type="text" name="type_group" size="20"><br>
              <small>
        ...
        <div class="tab-pane" id="tab-2">
          <div class="well">
            <div class="panel-side">
              <%List<User> list= groupDao.selectUserInGroupById(idGroup);
                for(User g:list ){
              %>
              <div class="usertop">
                <img src="/socc2s/images/camera_200.png" width="40" height="40">
                <div class="name"><a href="/poiscPolsovatelya?id=<%=g.getID()%>" name="log"><%=g.getlogin()%></a></div>
