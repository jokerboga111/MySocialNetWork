s3w<%@ page import="Galaxy.Chat.ChatConstants" %>
...
<div id="wrapper">
    ...
    <div id="content">
        ...
        <form action="/lichnoeSoobshenye?id=<%=u.getID()%>" method="post">
        Кому:<br>
        <input type="text" name="komu" value="<%=request.getParameter("login")%>"><br><br>
        Cообщение:<br>
        <textarea name="chat" rows="7" cols="45">
        </textarea><br><br>
