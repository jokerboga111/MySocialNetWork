...
<head>
  ...
  <% UserDao rec=new UserDaoJdbc();
    ...
    Iformation_User Informetion_user=Iu.SelectUserInformation(idFriend);
...
<div class="col-md-10 col-sm-11 display-table-cell2 valign-top">
  <div class="row1">
    <div class="panel-body" style="background-color:#fff;color:#000000;">
      ...
      <div class="well" >
        <form action="/lichnoeSoobshenye?id=<%=u.getID()%>&idfriend=<%=idFriend%>" method="post">
          Кому:<br>
          <input type="text" name="komu" value="<%=Informetion_user.getName()%> <%=Informetion_user.getSerName()%>"><br><br>
          Cообщение:<br>
        <textarea name="soobshenye" rows="7" cols="45">
        </textarea><br><br>
