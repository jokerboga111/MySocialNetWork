    ...
    <div class="col-md-10 display-table-cell">
      ...
      <div class="col-md-2 col-sm-1 hidden-xs display-table-cell1 valign-top" id="side-menu"  >
        ...
        <li class="link" width="20">
          <a href="/socc2s/erd/lichnoesoobshenye.jsp?idfriend=<%=u.getID()%>">
            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
            <span class="hidden-sm hidden-xs">Отправить сообщение</span>
          </a>
        </li>
        <li class="link" width="20">
          <a href="Redactor.jsp#tab-1">
            <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>
            <span class="hidden-sm hidden-xs">Добавить в друзья</span>
          </a>
        </li>
