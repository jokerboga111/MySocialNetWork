  ...
  <div class="row1">
    <div class="panel-body" style="background-color:#fff;color:#000000;">
      ...
      <ul class="nav nav-tabs">
        <li class="active"><a href="#tab-1" data-toggle="tab">Группы</a></li>
        <li><a href="#tab-2" data-toggle="tab">Публичныее страницы</a></li>
        <li><a href="#tab-3" data-toggle="tab">Мероприятия</a></li>
        <li><a href="#tab-4" data-toggle="tab">Управление</a></li>
      </ul>
      <div class="tab-content">
          ...
          <div class="well">
            <div class="panel-side">
              <form class="navbar-form navbar-left" role="search">
                ...
                <button type="submit"  class="btn btn-default"><a href="creategroup.jsp">Создать группу</a></button>
              <br><br> <br><br>
              <% DaoGroups daogroup =new DaoGroupsJDBC();
                List<Groups> gr= daogroup.selectMyGroupById(u.getID());
                for(Groups groups:gr ){

              %>
              <div class="usertop">
                <img src="/socc2s/images/camera_200.png" width="40" height="40">
                <div class="name"><a href="/socc2s/erd/hgroup.jsp?idGroup=<%=groups.getIdGroup()%>&NameGroup=<%=groups.getNameGroup()%>&idUser=<%=u.getID()%>" name="log"><%=groups.getNameGroup()%></a></div>
              </div>
              <%}%>
            </div>
          </div>
        ...
        <div class="tab-pane" id="tab-4">
          <div class="well">
            <div class="panel-side">
              <%List<Groups> list= groupDao.selectAdminGroupById(u.getID());
                for(Groups g:list ){
              %>
              <div class="usertop">
                <img src="/socc2s/images/camera_200.png" width="40" height="40">
                <div class="name"><a href="/socc2s/erd/UpravlenyeGroup.jsp?idGroup=<%=g.getIdGroup()%>&NameGroup=<%=g.getNameGroup()%>&idUser=<%=u.getID()%>" name="log"><%=g.getNameGroup()%></a></div>
              </div>
              <%}%>
            </div>
          </div>
