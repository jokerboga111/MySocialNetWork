...
<div id="wrapper">
    <div id="wrap-content">
        ...
        <div id="content">
            ...
            <div id="header1">
                <ul>
                    <li><a href="/socc2s/friends/OnlineFriends.jsp">Информация</a></li>
                    <li><a href="/PoiskDruzey?idfri=<%=u.getID()%>">Черный список</a></li>
                    <li><a href="/PoiskUchastnikov?idGroup=<%=request.getParameter("idGroup")%>">Учаснтники</a></li>
                    <li><a href="/zayavkiadmin?idZ_A=<%=request.getParameter("idGroup")%>&NameGroup=<%=request.getParameter("NameGroup")%>">Заявки</a></li>
                    <li><a href="/PoiskZayavka?idZ=<%=u.getID()%>">Сылки</a></li>
                </ul>
            </div>
